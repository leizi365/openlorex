...
import { PlateElement, useEditorMounted, useElement, withHOC } from 'platejs/react';
...
export const VideoElement = withHOC(
  ...
  function VideoElement(
    ...
    const element = useElement<TVideoElement & TResizableProps>();
        ...
        <PlateElement className="py-2.5" {...props}>
          <figure className="relative m-0 cursor-default" contentEditable={false}>
            <MediaResizeContainer selected={selected && focused}>
              ...
              >
                <div className="group/media" style={sizeStyle} data-media-content>
              <ResizeHandle
