...
export const mediaResizeHandleVariants = cva(
  cn(
    ...
    "after:flex after:h-16 after:w-[3px] after:rounded-[6px] after:bg-ring after:content-['_']",
    'after:opacity-0 group-hover/media-resize:after:opacity-100 group-data-[selected=true]/media-resize:after:opacity-100',
